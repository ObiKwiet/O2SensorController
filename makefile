#******************************************************************************
# Generated by VisualTeensy V1.5.0 on 11/9/2022 at 3:08 PM
#
# Board              Teensy 4.1
# USB Type           Serial
# CPU Speed          600 MHz
...
TARGET_NAME      := O2Sensor
BOARD_ID         := TEENSY41

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\sethg\Documents\Arduino\libraries
LIBS_SHARED      := 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := Wire Adafruit_MCP4725-2.0.0 Adafruit_BusIO-1.14.1 SPI 
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=157 -DARDUINO_TEENSY41 -DARDUINO=10813
